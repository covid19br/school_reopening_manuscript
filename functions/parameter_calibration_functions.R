...
run_simulations <- function(parameters, date_parameters, params.df, output.f,
    ...
    generate_modelRun <- function(sensitive.params, parameters,
        ...
        f <- function(...){
            ...
            if ('shift_start' %in% sensitive.params){
                ...
                date_parameters['startdate'] <- date_parameters['startdate'] + parameters['shift_start']
            ...
            out <- run_covid19(parameters, date_parameters, Y)
            return(output.f(out[[2]], parameters, date_parameters))
        }
    }
